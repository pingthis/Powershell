...
function Renew-Certificate {
    ...
    Process {
      ...
      if ($Error.Count -eq 0) {
        $Cert=New-Object -TypeName Security.Cryptography.X509Certificates.X509Certificate2([System.Convert]::FromBase64String($Enroll.Certificate(1)))
#        $Cert.Import([System.Convert]::FromBase64String($Enroll.Certificate(1)))
  ...
  Renew-Certificate "7bb04402038924086c0f9f38fde4b5786eb40e82"